...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, UINT wParam, LONG lParam) {
    ...
    static LOGFONT lf, tempLf;      /*
                                     * the logical font for CreateFontIndirect()
    ...
    switch (message) {
        case WM_CREATE:
            ...
            for (int i = 0; i < 16; i++)                /* set all custom colors to white */
        ...
        case WM_COMMAND:
            switch (wParam) {
                ...
                case IDM_HEX:
                    ...
                    switch (wParam) {                               /* set the mathematical base */
                        case IDM_BIN:
                            Base = 2;
                            break;
                        case IDM_OCT:
